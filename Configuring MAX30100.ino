...
int MAX30101_MODE_HR       = 0x2;
int MAX30101_MODE_SPO2     = 0x3;
int MAX30101_MODE_MULTILED = 0x7;

//int MAX30101_MODE[3];
//MAX30101_MODE[0] = MAX30101_MODE_HR;
//MAX30101_MODE[1] = MAX30101_MODE_SPO2;
//MAX30101_MODE[2] = MAX30101_MODE_MULTILED;
...
//    Serial.print(",");
    ...
    Serial.print("Green LED counts: ");
    Serial.println(body.greenLed);
